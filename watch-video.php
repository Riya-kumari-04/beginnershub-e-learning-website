...
<section class="watch-video">
   ...
   <div class="video-container">
      <div class="video">
         <video src="/beginners-hub/img/vid-1.mp4" controls poster="/beginners-hub/img/post-1-1.jpg" id="video"></video>
      </div>
      <h3 class="title">complete HTML tutorial (part 01)</h3>
      <div class="info">
         <p class="date"><i class="fas fa-calendar"></i><span>22-1-2024</span></p>
